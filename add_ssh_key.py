...
try:
    ...
    ssh.connect('207.154.225.70', port=22, username='root', timeout=20, allow_agent=False, look_for_keys=False)
    print("Ulandi!")
...
try:
    ...
    ssh2.connect('207.154.225.70', port=22, username='root', pkey=pkey, timeout=20, allow_agent=False, look_for_keys=False)
...
try:
    ...
    ssh3.connect('207.154.225.70', port=22, username='root', timeout=15, allow_agent=False, look_for_keys=False)
