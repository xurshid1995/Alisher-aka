...
sudo nano /etc/systemd/system/alisher-aka.service
```
...
sudo  # Server Setup - 46.101.153.212 (www.sergeli0606.uz)
...
# Service'ni yoqish
sudo systemctl daemon-reload
sudo systemctl enable alisher-aka.service
sudo systemctl start alisher-aka.service
sudo systemctl status alisher-aka.service
```
...
cd /var/www/alisher-aka
git pull
sudo systemctl restart alisher-aka.service
```
...
# Loglarni ko'rish
sudo journalctl -u alisher-aka.service -f
...
### Service ishlamasa:
```bash
sudo journalctl -u alisher-aka.service -n 50 --no-pager
```
...
# Git'ni yangilash
cd /var/www/alisher-aka && git pull && sudo systemctl restart alisher-aka.service
```
...
.Value -replace 'xurshid','alisher-aka' .service
sudo  # Server Setup - 46.101.153.212 (www.sergeli0606.uz)
...
# Git'ni yangilash
cd /var/www/alisher-aka && git pull && sudo  # Server Setup - 46.101.153.212 (www.sergeli0606.uz)
